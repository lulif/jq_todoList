					...
					switch(a && "object" === ("undefined" == typeof a ? "undefined" : _typeof(a)) && "function" == typeof a.toJSON && (a = a.toJSON(t)), "function" == typeof rep && (a = rep.call(e, t, a)), "undefined" == typeof a ? "undefined" : _typeof(a)) {
						...
						case "object":
							...
							if(rep && "object" === ("undefined" == typeof rep ? "undefined" : _typeof(rep)))
								...
								for(r in a) Object.prototype.hasOwnProperty.call(a, r) && (o = str(r, a), o && u.push(quote(r) + (gap ? ": " : ":") + o));
							return o = 0 === u.length ? "{}" : gap ? "{\n" + gap + u.join(",\n" + gap) + "\n" + s + "}" : "{" + u.join(",") + "}", gap = s, o
					}
				}
				var rx_one = /^[\],:{}\s]*$/,
							...
							for(i = 0; i < t.length; i += 1)
								if(a = t.charAt(i), Object.prototype.hasOwnProperty.call(u, a) || (u[a] = p++, s[a] = !0), c = f + a, Object.prototype.hasOwnProperty.call(u, c)) f = c;
									...
									if(Object.prototype.hasOwnProperty.call(s, f)) {
										...
										for(o = u[f], r = 0; r < h; r++) g = g << 1 | 1 & o, v == e - 1 ? (v = 0, d.push(n(g)), g = 0) : v++, o >>= 1;
			...
			function o(t, e, n) {
				...
				var v = {
						...
						_addPlugin: function(t) {
							var e = this;
							if(l(t)) return void a(t, function(t) {
								e._addPlugin(t)
							});
